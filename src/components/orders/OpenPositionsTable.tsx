    ...
    <div className="rounded-md border overflow-hidden">
      <Table>
        <TableHeader className="bg-muted/60">
          <TableRow>
            <TableHead className="whitespace-nowrap py-3 px-2 text-left">
              Symbol
            </TableHead>
          ...
          {openTrades.map((trade) => {
            ...
            return (
              <TableRow key={trade.id} className="border-b hover:bg-muted/40">
                ...
                <TableCell className="py-3 px-2 text-right">
                  {formatCurrency(trade.marketRate)}
                </TableCell>
                <TableCell className="py-3 px-2 text-right text-red-500">
                  {formatCurrency(bid)}
                </TableCell>
                <TableCell className="py-3 px-2 text-right text-green-500">
                  {formatCurrency(ask)}
                </TableCell>
                <TableCell className="py-3 px-2 text-right">
