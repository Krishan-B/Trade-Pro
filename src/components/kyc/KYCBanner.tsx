    ...
    return (
      <Alert className="border-green-200 bg-green-50">
        ...
        <AlertDescription className="text-green-800">
          Your KYC verification is complete. You can now access all trading
          features.
        </AlertDescription>
      </Alert>
    );
    ...
    return (
      <Alert className="border-red-200 bg-red-50">
        ...
        <AlertDescription className="flex items-center justify-between text-red-800">
          <span>
            Your KYC documents have been rejected. Please upload new documents.
          </span>
          <Button
            variant="outline"
            size="sm"
    ...
    return (
      <Alert className="border-orange-200 bg-orange-50">
        ...
        <AlertDescription className="flex items-center justify-between text-orange-800">
          <span>
            One last step before trading - Complete your KYC verification
          </span>
          <Button
            variant="outline"
            size="sm"
