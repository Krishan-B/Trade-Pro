      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div
              className={`text-xs px-2 py-1 rounded-full ${marketIsOpen ? "bg-success/20 text-success" : "bg-warning/20 text-warning"}`}
            >
          ...
          <div className="pt-2">
            ...
            {!marketIsOpen && (
              <div className="mt-2 text-xs text-warning text-center">
                The market is currently closed. Please try again during market
                hours.
              </div>
            )}
          </div>
